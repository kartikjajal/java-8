...
public class Functional1Test {
    ...
    private static final Functional1 subject = new Functional1();
    ...
    @DisplayName("Perform : ")
    void testFunctionSum(Functional1.BinaryIntOp binaryIntOp, int a, int b, int expected) {
    ...
    void test_compute(Function<BinaryIntOpInput, Integer> function,int a, int b, int expected){
        int actual = subject.compute(function,
                BinaryIntOpInput.builder().a(a).b(b).build());
        Assertions.assertEquals(expected,actual);
    }
